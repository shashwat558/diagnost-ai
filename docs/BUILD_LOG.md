...
How Diagnost AI was built, phase by phase — kept for contributors and the curious. If you just want to use the product, start with the [README](../README.md) and the [docs site](http://localhost:3100/docs).
